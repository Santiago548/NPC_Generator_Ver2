...
export const NpcClasses = () => {
  return (
    ...
    <fieldset className="classesContainer">

      <fieldset className="leftClassDescription">
        <h2>Barbarian</h2>
        <p>
      ...
      <fieldset className="rightClassDescription">
        <h2>Bard</h2>
...
<fieldset className="classesContainer">
      ...
      <fieldset className="rigthClassDescription">
        <h2>Sorcerer</h2>
        <p>
...
<fieldset className="classesContainer">
      ...
      <fieldset>
        ...
        <p>
          ...
          extraordinary capabilities in objects.
        </p>
        <p>
          <strong>Hit Die: </strong>
          d8
