...
export const NpcRaces = () => {
    return (
        <div>
            ...
            <h2>Half-Orc</h2>
            <p>Half-orcs’ grayish pigmentation, sloping foreheads, jutting jaws, prominent teeth, and towering builds make their orcish heritage plain for all to see.</p>
            <h2>Tiefling</h2>
            ...
            <h2>Goliath</h2>
            <p>Strong and reclusive, every day brings a new challenge to a goliath.</p>
            <h2>Firbolg</h2>
            <p>Firbolg tribes cloister in remote forest strongholds, preferring to spend their days in quiet harmony with the woods.</p>
            <h2>Goblin</h2>
            <p>Goblins occupy an uneasy place in a dangerous world, and they react by lashing out at any creatures they believe they can bully.</p>
            <h2>Orc</h2>
            <p>Orcs live a life that has no place for weakness, and every warrior must be strong enough to take what is needed by force.</p>
            <h2>Tabaxi</h2>
            <p>Hailing from a strange and distant land, wandering tabaxi are catlike humanoids driven by curiosity to collect interesting artifacts, gather tales and stories, and lay eyes on all the world’s wonders.</p>
            <h2>Warforged</h2>
            <p>Warforged are made from wood and metal, but they can feel pain and emotion. Built as weapons, they must now find a purpose beyond war.</p>
        </div>
    )
}
