...
class NpcRandom extends Component {
    ...
    handleClick = event => {
        ...
        const backgroundArray = [
          ...
          `${firstName} served as a squire to the ${firstName}nger son of a local lord, a minor political figure. Two years ago he moved to the city, to study magic and indulge in debauchery, and released ${firstName} from their service (and their salary). ${firstName}'ve heard that Bordertown has uses for someone with skill of arms, and so ${firstName}'ve hopped onto the first coach available.`,
            ...
            `A radiant portal spit ${firstName} out. The last words ${firstName} remember was 'Penance'. Aasimar know who ${firstName} is, but won't disclose it even under torture.`,
            `Raised by pirates ${firstName} raided the wrong temple and ${firstName} was the sole surviver.`,
            `Raised by ogres ${firstName} always threatened to eat ${firstName} growing up. ${firstName} payed them tribute and grew above the goblin ranks. Eventually ${firstName} made their bid for freedom by poisoning all their dinner. ${firstName} are a legend amongst the goblins and ogres.`,
